...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	// Add callback delegate to session interface
...
void AMenuSystemCharacter::JoinGameSession()
{
	...
	// Add delegate for callback to session interface
	OnlineSessionInterface->AddOnFindSessionsCompleteDelegate_Handle(FindSessionsCompleteDelegate);

	// Create SessionSearch settings
	SessionSearch = MakeShareable(new FOnlineSessionSearch());
	SessionSearch->MaxSearchResults = 1000000; // Set higher if struggling whilst using AppID 480
